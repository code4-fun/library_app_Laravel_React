          ...
          <?php if(Auth::user()->role == '0' || Auth::user()->role == '1'): ?>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li><a class="dropdown-item" href="<?php echo e(route('category.create')); ?>">Добавить категорию</a></li>
          ...
          <?php if(Auth::user()->role == '0' || Auth::user()->role == '1'): ?>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li><a class="dropdown-item" href="<?php echo e(route('category.index')); ?>">Список категорий</a></li>
                <?php if(Auth::user()->role == '0'): ?>
            ...
            <div id="category_filter">
              <div class="filter_category">
                ...
                <div class="dropdown" id="category_dropdown_filter" style="height: 20px;">
                  <button class="dropdown-toggle category_dropdown_toggle"
                          id="calendar_category_filter" data-bs-toggle="dropdown">Все
                  </button>
                  <div class="dropdown-menu calendar_category_dropdown" aria-labelledby="calendar_category_filter">
